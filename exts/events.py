...
class Events(commands.Cog):
    def __init__(self, bot):
        ...
        self.reactions = [
            ...
            "hit that subscribe button and join the react army",
            ...
            "hmm im gonna need a mini reactbot for this one it stinks",
            ...
            "subscribe to join the react family",
