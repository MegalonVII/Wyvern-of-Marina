    ...
    def __init__(self, bot):
        ...
        self.consoles = {
            ...
            'switch': { # greemdev ryujinx
                "links": ["[Emulator](<https://github.com/GreemDev/Ryujinx/releases/>)", "[ROMs](<https://www.ziperto.com/nintendo-switch-nsp-list/>)", "[Firmware](<https://prodkeys.net/ryujinx-firmware/>)", "[Keys](<https://prodkeys.net/ryujinx-prod-keys/>)", "[Ad blocker](<https://ublockorigin.com/>)"],
