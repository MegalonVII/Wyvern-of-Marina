...
class Fun(commands.Cog):
    def __init__(self, bot):
        ...
        self.consoles = {
            ...
            # add sg1000, mastersystem, genesis, gamegear, 32x, saturn, dreamcast
        }
