...
class Fun(commands.Cog):
    def __init__(self, bot):
        ...
        self.consoles = {
            ...
            'switch': { # ryubing
                "links": ["[Ryubing](<https://ryujinx.app/>)", "[ROMs](<https://sor.bz/7FbLS>)", "[Firmware](<https://prodkeys.net/ryujinx-firmware/>)", "[Keys](<https://prodkeys.net/ryujinx-prod-keys/>)", "[Ad blocker](<https://ublockorigin.com/>)"],
