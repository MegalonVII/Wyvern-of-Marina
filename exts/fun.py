...
class Fun(commands.Cog):
    def __init__(self, bot):
        ...
        self.consoles = {
            ...
            'ps2': { # pcsx2
                "links": ["[Emulator](<https://pcsx2.net/>)", "[ROMs](<https://bit.ly/4gsD8oq>)", "[BIOS](<https://bit.ly/4gl7lpp>)", "[Covers](<https://bit.ly/4g9LmS2>)"],
