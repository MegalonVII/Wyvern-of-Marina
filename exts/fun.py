    ...
    def __init__(self, bot):
        ...
        self.consoles = {
            ...
            'switch': { # greemdev ryujinx
                "links": ["[Emulator](<https://sor.bz/iFSur>)", "[ROMs](<https://sor.bz/7FbLS>)", "[Firmware](<https://prodkeys.net/ryujinx-firmware/>)", "[Keys](<https://prodkeys.net/ryujinx-prod-keys/>)", "[Ad blocker](<https://ublockorigin.com/>)"],
